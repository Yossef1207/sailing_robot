...
const AP_Param::Info Rover::var_info[] PROGMEM = {
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(rudder_min,        "RUDDER_MIN", RUDDER_MIN_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(rudder_mid,        "RUDDER_MID", RUDDER_MID_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(rudder_max,        "RUDDER_MAX", RUDDER_MAX_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(sail_min,          "SAIL_MIN", SAIL_MIN_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(sail_mid,          "SAIL_MID", SAIL_MID_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(sail_max,          "SAIL_MAX", SAIL_MAX_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(target_apparent,    "TARGET_APPARENT", TARGET_APPARENT_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(target_course,    "TARGET_COURSE", TARGET_COURSE_DEFAULT),
    ...
    // @User: Advanced
	GSCALAR(target_mode,      "TARGET_MODE",     TARGET_MODE_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(wind_min,          "WIND_MIN", WIND_MIN_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(wind_mid,          "WIND_MID", WIND_MID_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(wind_max,          "WIND_MAX", WIND_MAX_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(sail_angle,          "SAIL_ANGLE", SAIL_ANGLE_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(sail_step,          "SAIL_STEP", SAIL_STEP_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(sail_gap,          "SAIL_GAP", SAIL_GAP_DEFAULT),

    // boat
    // @Param: servo_increment
    // @DisplayName: sail channel maximum
    // @Description: maximum output for sail
    // @Values:
    // @User: Advanced
	GSCALAR(servo_increment,          "SERVO_INCREMENT", SERVO_INCREMENT_DEFAULT),
    ...
    // @Values:
    // @User: Advanced
	GSCALAR(r_servo_upright,          "R_SERVO_UPRIGHT", R_SERVO_UPRIGHT_DEFAULT),



	GSCALAR(camera_roll_min,"camera_roll_min", 750),
	GSCALAR(camera_roll_mid,"camera_roll_mid", 1400),
	GSCALAR(camera_roll_max,"camera_roll_max", 2000),
	GSCALAR(roll_range,"roll_range", 90),

	GSCALAR(camera_yaw_min,"camera_yaw_min", 1050),
	GSCALAR(camera_yaw_mid,"camera_yaw_mid", 1400),
	GSCALAR(camera_yaw_max,"camera_yaw_max", 2000),
	GSCALAR(yaw_range,"yaw_range", 270),

	GSCALAR(cam_yaw_target,"cam_yaw_target", 0),
