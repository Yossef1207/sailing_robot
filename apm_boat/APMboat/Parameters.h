...
public:
    ...
    enum {
        ...
        k_param_sail_step,
        k_param_sail_gap,
        k_param_servo_increment,
        k_param_r_servo_upright,

        // camera gimbal parameters
        k_param_camera_roll_min=70,
        k_param_camera_roll_mid,
        k_param_camera_roll_max,
        k_param_roll_range,

        k_param_camera_yaw_min,
        k_param_camera_yaw_mid,
        k_param_camera_yaw_max,
        k_param_yaw_range,
        k_param_cam_yaw_target,
    ...
    AP_Int16    sail_step;
    AP_Int16    sail_gap;
    AP_Int16    servo_increment;
    AP_Int8     r_servo_upright;

    // camera gimbal parameters
    AP_Int16    camera_roll_min;
    AP_Int16    camera_roll_mid;
    AP_Int16    camera_roll_max;
    AP_Int16    roll_range;  // the angle between the min and max

    AP_Int16    camera_yaw_min;
    AP_Int16    camera_yaw_mid;
    AP_Int16    camera_yaw_max;
    AP_Int16    yaw_range;   // the angle between the min and max
    AP_Int16    cam_yaw_target;
